# Vibe コーディングのサンプル製品要件ドキュメント (PRD)

このドキュメントには、Vibe コーディング プロジェクトの PRD テンプレートを効果的に使用する方法を説明するサンプル PRD のコレクションが含まれています。

## PRD テンプレート

製品要件ドキュメント (PRD) テンプレート。
...
このセクションには、Vibe コーディングの PRD テンプレートを効果的に使用する方法を示すサンプル PRD が含まれています。

### サンプル 1 - ペット里親募集 Web アプリの製品要件ドキュメント (PRD)
...
### サンプル 2 - DevDiv チームの Wendy から (MyTodoListApp の Copilot カスタム手順)
